class TrainersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @trainer.save
        format.html { redirect_to @trainer, success: "#{t(:trainer)} #{define_notice('m', __method__)}" }
  ...
  def destroy
    @trainer.destroy
    respond_to do |format|
      format.html { redirect_to trainers_url, success: "#{t(:trainer)} #{define_notice('m', __method__)}" }
