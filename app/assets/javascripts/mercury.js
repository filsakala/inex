...
window.Mercury = {
    ...
    config: {
        ...
        toolbars: {
            primary: {
                save: ['Save', 'Uložiť túto stránku'],
                preview: ['Preview', 'Ako to bude vyzerať po uložení', {
                    toggle: true,
                    mode: true
                }],
                sep1: ' ',
            ...
            editable: {
                ...
                colors: {
                    backColor: ['Background Color', 'Background', {
        ...
        '[data-mercury] table { border: 1px solid black; min-width: 200px; width: 100% }' +
        '[data-mercury] th    { border: 1px solid black; min-width: 200px; }' +
        '[data-mercury] td    { border: 1px solid black; min-width: 200px; }' +
