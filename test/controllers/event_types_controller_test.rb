...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { conditions: @event_type.conditions, fees: @event_type.fees, title: @event_type.title }
    end
  ...
  test "should update event_type" do
    patch :update, id: @event_type, event_type: { conditions: @event_type.conditions, fees: @event_type.fees, title: @event_type.title }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
